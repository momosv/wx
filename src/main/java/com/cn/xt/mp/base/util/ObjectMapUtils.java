...
public class ObjectMapUtils {
     ...
     * @throws Exception 异常
     */
    public static Object mapToObject(Map<String, Object> map, Class<?> clazz,boolean isLineToHump) throws Exception {
        Object obj = clazz.newInstance();
        if(map != null && map.size() > 0) {
            for(Map.Entry<String, Object> entry : map.entrySet()) {
                String propertyName = entry.getKey();       //属性名
                if(isLineToHump) {
                	propertyName=RegexUtils.lineToHump(propertyName);
                }
